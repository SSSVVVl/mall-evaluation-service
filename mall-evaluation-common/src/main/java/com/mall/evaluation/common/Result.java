package com.mall.evaluation.common;
...
public class Result<T> implements Serializable {
    ...
    public static <T> Result<T> unauthorized() {
        return fail(HTTP_UNAUTHORIZED, Resp.UNAUTHORIZED.getCode(), Resp.UNAUTHORIZED.getMessage(), null);
    }
    ...
    public static <T> Result<T> forbidden() {
        return fail(HTTP_FORBIDDEN, Resp.PERMISSION_DENIED.getCode(), Resp.PERMISSION_DENIED.getMessage(), null);
    }
    ...
    public static <T> Result<T> notFound() {
        return fail(HTTP_NOT_FOUND, "EVAL00404", "资源不存在", null);
    }
}